...
{/* pehli div  image wali  */}

<Picture/>

 
 <div className='w-[40%] h-[50rem] flex flex-col'>
<h1 className='text-[2.5rem] text-gray-600'>Cheif</h1>
 <h1 className='text-[4rem] text-white'>AI UI <br />ARCHITECT</h1>
 <h1 className='text-[1.4rem] text-gray-600'>DESIGNER AND DEVELOPER</h1>
